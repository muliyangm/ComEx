...
class PretrainCIFARDataModule(pl.LightningDataModule):
    def __init__(self, args):
        ...
        self.num_novel_classes = args.num_novel_classes
    ...
    def setup(self, stage=None):
        labeled_classes = range(self.num_base_classes)
...
class DiscoverCIFARDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        unlabeled_classes = range(
            self.num_base_classes, self.num_base_classes + self.num_novel_classes
        )
    ...
    def dataloader_mapping(self):
        return {0: "novel/train", 1: "novel/test", 2: "base/test"}
